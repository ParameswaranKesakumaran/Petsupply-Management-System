...
public class SearchSupplyForm extends javax.swing.JFrame {
 private DefaultTableModel tableModel;
    
    public SearchSupplyForm() {
        initComponents();
   ...
   // @SuppressWarnings("unchecked")
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            String query = "SELECT * FROM PetSupplies WHERE category LIKE ?";
            ...
            JOptionPane.showMessageDialog(this, "Error searching supplies: " + e.getMessage());
        }
    ...
    // public static void main(String[] args) {
     //   java.awt.EventQueue.invokeLater(() -> new SearchSupplyForm().setVisible(true));
  //  }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchSupplyForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
